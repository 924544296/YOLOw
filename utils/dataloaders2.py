...
class LoadImagesAndLabels(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return torch.from_numpy(img), labels_out, self.path + self.list_data[index], shapes
    ...
    def load_image(self, i):
        ...
        labels = data[1:]
        #
        image, labels = self.make_data(image, labels) ###
        ...
        return image, (h0, w0), image.shape[:2], labels  # im, hw_original, hw_resized
