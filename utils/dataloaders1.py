...
class LoadImagesAndLabels(Dataset):
    ...
    def paste_mask(self, image_background, image_foreign):
        ...
        #
        # if image_background_roi_expand0.astype('float32').mean() >= 245 and self.no_label:
        #     return image_background, None
        # else:
    ...
    def paste_foreign_to_background(self, image_background):
        ...
        if np.random.randint(3):
            image_background = self.rotate(image_background, 255, expand=True)
            image_background = self.crop_background(image_background)
        elif np.random.randint(2):
            image_background = self.rotate(image_background, 255, expand=False)
